...
?>
	<table align="center" height="auto" border="1" cellspacing="0" cellpadding="2" style="font-size:15px; width:1050px;">
		...
		<th class="text-center unicode-to-bijoy">শিক্ষাগত যোগ্যতা</th>
		...
		<tr>
			...
			<td class="text-center unicode-to-bijoy"><?php echo $row->education?></td>
			<td class="text-center unicode-to-bijoy"><?php echo $row->blood == 'None'?'-' : $row->blood ?></td>
