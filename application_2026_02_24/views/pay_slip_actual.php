 ...
 $this->load->view('head_bangla'); ?>
  ...
  <!--add-->
	...
	<tr>
	  	...
	  	<td >:</td>
		<td width="59" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $total_days = $rows["total_deduct"];   ?> </font></td>
	</tr>
   ...
   <div style="border-bottom:1px solid #000000; line-height: 25px;"><table width="295" cellspacing="0" cellpadding="0">
	  ...
	  <td width="45" style="padding-right: 12px;" align="right"> 
		...
		<?php 
			...
			if($rows['ot_entitle']==1 && $staff==1){
				$ot_amount = 0;
				$eot_amount = 0;
				$double_to = $rows["ot_amount"];
				$net_pay = $rows["net_pay"] - $rows['ot_amount'];

			}elseif($rows['ot_entitle']==0 && $staff==0){
				$ot_amount =  $rows["ot_amount"];
				$eot_amount = $rows["eot_amount"];
				$net_pay = $rows["net_pay"] + $rows["eot_amount"];
			}
			else{
				$ot_amount =  0;
				$eot_amount = 0;
    ...
    <tr>
      ...
      <td >:</td>
	  <td width="78" style="padding-right: 9px;" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $total_days = $net_pay + $due_pay_add;   ?> </font></td>
    </tr></table></div>
  </div>
