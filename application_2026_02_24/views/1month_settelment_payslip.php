...
foreach($value as $rows)
{
                    ...
                    <?php if($i % 3 == 0)
	{
		...
		//echo "</div>";
                    ...
                    <div
                        style="width:315px; height:auto; overflow:hidden; font-size:9px; font-family: SolaimanLipi;margin-bottom:50px; border:1px solid black;">
 ...
 $this->load->view('head_bangla'); ?>
                            ...
                            <span style="font-size:12px; font-weight:bold;">&#2474;&#2503; -
                                &#2488;&#2509;&#2482;&#2495;&#2474;-<span
   ...
   ?>
                        ...
                        <div
                            style="width:312px; margin-top:12px; line-height: 14px; height:auto; overflow:hidden; border:1px solid #000000;">


                            <div
                                style="width:100%; border-bottom:1px solid #000000; height:auto; overflow:hidden; line-height:11px;">
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="76" style="font-size: 10px;">&#2472;&#2494;&#2478; </td>
                                        <td width="100">
                                            <font style="font-family:SutonnyMJ; font-size: 8px;">:
                                                <strong><?php echo $rows["bangla_nam"];?></strong> </font>
                                        </td>
                                        <td width="72">গ্রেড</td>
                                        <td width="75">
                                            <font style="font-family: SutonnyMJ;font-size: 11px;">:
                                                <?php echo $rows["gr_name"];   ?> </font>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="100">
                                            <font style="font-family:'Times New Roman', Times, serif;font-size: 11px;">:
                                                <?php echo $rows["desig_bangla"];   ?> </font>
                                        </td>
                                        ...
                                        <td width="75" style="font-size: 10px;">
                                            <font style="font-family:'Times New Roman', Times, serif;font-size: 11px;">:
                                                <?php echo $rows["dept_bangla"];   ?> </font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="76" style="font-size: 10px;">&#2453;&#2494;&#2480;&#2509;&#2465;</td>
                                        <td width="100">
                                            <font style="font-family:SutonnyMJ;font-size: 11px; font-weight: bold;">:
                                                <?php echo $rows["emp_id"];   ?></font>
                                        </td>
                                        <td width="72" style="font-size: 10px;">&#2488;&#2503;&#2453;&#2486;&#2472;
                                        </td>
                                        <td width="75">
                                            <font style="font-family:'Times New Roman', Times, serif;font-size: 11px;">:
                                                <?php echo $rows["sec_bangla"];   ?></font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="76" style="font-size: 10px;">
                                            ...
                                            &#2468;&#2494;&#2480;&#2495;&#2454; </td>
                                        <td width="100">
                                            <font style="font-family:SutonnyMJ, Times, serif;font-size: 11px;">:
                                                <?php 
			...
			?>
                                        ...
                                        <td width="75">
                                            <font style="font-family:'Times New Roman', Times, serif;font-size: 11px;">:
                                                <?php echo $rows["line_bangla"];   ?> </font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="76" style="font-size: 10px;">&#2478;&#2507;&#2463;
                                            &#2470;&#2495;&#2472; </td>
                                        <td width="100">
                                            <font style="font-family: SutonnyMJ; font-size:14px;font-size: 11px;">:
                                                <?php echo $total_days = $rows["total_days"];   ?> </font>
                                        </td>
		...
		//	$holidy_or_weeked = $rows["holiday_or_weeked"];   
			...
			?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="100">
                                            <font style="font-family: SutonnyMJ; font-size:14px;">:
                                                <?php echo $total_days = $rows["absent_days"];   ?> </font>
                                        </td>
                                        <td width="72" style="font-size: 10px;">
                                            &#2441;&#2474;&#2488;&#2509;&#2469;&#2495;&#2468;&#2495; </td>
                                        <td width="75">
                                            <font style="font-family: SutonnyMJ; font-size:14px;">:
                                                <?php echo $total_days = $rows["att_days"];   ?> </font>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="100">
                                            <font style="font-family: SutonnyMJ; font-size:14px;">:
                                                <?php echo $total_days = $rows["weekend"];   ?> </font>
                                        </td>
                                        <td width="72" style="font-size: 10px;">&#2451;&#2463;&#2495;
                                            &#2456;&#2472;&#2509;&#2463;&#2494; </td>
                                        <td width="75">
                                            <font style="font-family: SutonnyMJ; font-size:14px;">:
                                                <?php echo $total_days = $rows["ot_hour"];   ?> </font>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="100" style="font-size: 10px;">
                                            <font style="font-family: SutonnyMJ; font-size:14px;">:
                                                <?php echo $total_days = $rows["holiday"];   ?> </font>
                                        </td>
                                        <td width="72" style="font-size: 10px;">&#2451;&#2463;&#2495;
                                            &#2480;&#2503;&#2463; </td>
                                        <td width="75">
                                            <font style="font-family: SutonnyMJ; font-size:14px;">:
                                                <?php echo $total_days = $rows["ot_rate"];   ?> </font>
                                        </td>
                                    </tr>
                            ...
                            <div style="width:100%; border-bottom:1px solid #000000; height:auto; overflow:hidden;">
                                ...
                                <div
                                    style="float:left; width:55px; height: auto; position:relative; left:5px; top:18px; font-weight:bold;">
                                    ...
                                    <table width="230" cellspacing="0" cellpadding="0" style="font-size: 11px;">
                                        <tr>
                                            ...
                                            <td width="70" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $total_days = $rows["basic_sal"];   ?> </font>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="12" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $total_days = $rows["house_r"];   ?> </font>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td width="160">&#2458;&#2495;&#2453;&#2495;&#2510;&#2488;&#2494;
                                                &#2477;&#2494;&#2468;&#2494; </td>
                                            <td>:</td>
                                            <td width="12" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $total_days = $rows["medical_a"];   ?> </font>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="12" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $trans_allow = $rows["trans_allow"];   ?> </font>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="12" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $food_allow = $rows["food_allow"];   ?> </font>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="12" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $total_days = $rows["gross_sal"];   ?> </font>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <div style="width:100%; border-bottom:1px solid #000000; height:auto; overflow:hidden;">
                                ...
                                <div
                                    style="float:left; width:55px; position:relative; left:5px; top:25px; font-weight:bold;">
                                    (খ) কর্তন </div>
                                    ...
                                    <table width="236" style="font-size: 11px;">
                                        ...
                                        <tr>
                                            ...
                                            <td width="59" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $total_days = $rows["adv_deduct"];   ?> </font>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="59" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $total_days = $rows["abs_deduction"];    ?> </font>
                                            </td>
                                        </tr>
                                        <!--<tr>
	  	<td width="152">লেট </td>
		...
		<td width="59" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $total_days = $rows["late_deduct"];    ?> </font></td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="59" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $total_days = $rows["stamp"];    ?> </font>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td width="152">&#2478;&#2507;&#2463; &#2453;&#2480;&#2509;&#2468;&#2472;
                                            </td>
                                            <td>:</td>
                                            <td width="59" align="right">
                                                <font style="font-family: SutonnyMJ; font-size:14px;">
                                                    <?php echo $total_days = $rows["total_deduct"];   ?> </font>
                                            </td>
                                        </tr>
                            ...
                            <div style="border-bottom:1px solid #000000; line-height: 25px;">
                                <table width="295" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="210"><span style="position:relative; left:5px; font-weight:bold;">
                                                (গ) উপস্থিত বোনাস </span></td>
                                        <td>:</td>
                                        <td width="45" style="padding-right: 10px;" align="right">
                                            <font style="font-family: SutonnyMJ; font-size:14px;">
                                                <?php echo $total_days = $rows["att_bonus"];   ?> </font>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="border-bottom:1px solid #000000; line-height: 25px;">
                                <table width="298" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="210"><span style="position:relative; left:5px; font-weight:bold;">
                                                (ঘ) অতিরিক্ত কাজ</span></td>
                                        <td>:</td>
                                        <td width="45" style="padding-right: 12px;" align="right">
                                            <span style="font-family: SutonnyMJ; font-size:14px;">
                                                <?php echo $total_days = $rows["ot_amount"];   ?> </span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table width="295" height="17" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="78" style="padding-right: 9px;" align="right">
                                            <font style="font-family: SutonnyMJ; font-size:14px;">
                                                <?php echo $total_days = $rows["net_pay"];   ?> </font>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        <div style=" width:315px; font-size:12px; padding-top:15px;">
                            <div style=" width:150px; float:left;">কর্তৃপক্ষের স্বাক্ষর</div>
                            <div style=" width:150px; float:right; text-align:right;">কর্মচারীর স্বাক্ষর</div>
   ...
   ?>
                        ...
                        <div
                            style="width:312px; height:auto; margin-top:12px; line-height: 14px; overflow:hidden; border:1px solid #000000;">
			...
			?>
                            ...
                            <div style="width:100%; border-bottom:1px solid #000000; height:auto; overflow:hidden;">
                                ...
                                <div
                                    ...
                                    (খ) কর্তন </div>
                                <div style="float: left; width:240px; border-left:1px solid #000000; line-height:8px;">
                                    <table width="237" style="font-size: 11px;">
