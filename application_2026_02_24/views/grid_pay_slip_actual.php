...
foreach($values as $rows)
{
	...
	<div style="width:100%; height:auto; ">
		<?php if($i % 2 == 0)
		{
			//echo "<div>";
			$k = $k + 1;
			echo "<div style='width:320px;;height:26px;text-align: right'>&nbsp;</div>";
			//echo "</div>";
		} ?>
		<div style="width:320px; height:auto; overflow:hidden; font-size:9px; font-family: SolaimanLipi;margin-bottom:30px; border:1px solid black;">
			...
			<div style="width:330px; margin-top:12px; line-height: 14px; height:auto; overflow:hidden; border-bottom:1px solid #000000; border-top:1px solid #000000;">
				<div style="width:100%; border-bottom:1px solid #000000; height:auto; overflow:hidden; line-height:11px;">
					<table width="300" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td width="75">
								<font style="font-family: SutonnyMJ;font-size:14px;">:
									<?php echo round($rows["ot_hour"] + $rows["eot_hour"]); ?>
								</font>
							</td>
						</tr>
						<tr>
				...
				<div style="float:left; width:55px; position:relative; margin-left:5px; top:25px; font-weight:bold;">(খ) কর্তন </div>
				...
				<table width="295" cellspacing="0" cellpadding="0">
						<tr>
						<td width="210" ><span style="position:relative; margin-left:5px; font-weight:bold;"> (গ) উপস্থিত বোনাস </span></td>
						<td >:</td>
				...
				<div style="border-bottom:1px solid #000000; line-height: 25px;">
					<table width="298" cellspacing="0" cellpadding="0">
						<tr>
							<td width="210"><span style="position:relative; margin-left:5px; font-weight:bold;"> (ঘ) ওভার টাইম</span></td>
							<td >:</td>
							<td width="45" style="padding-right: 12px;" align="right">
								<span style="font-family: SutonnyMJ; font-size:14px;" > <?php echo $rows["ot_amount"] + $rows["eot_amount"];?> </span>
							</td>
						</tr>
					</table>
				</div>
				...
				<div>
					<table width="295" height="17" cellspacing="0" cellpadding="0">
						<tr>
							<td width="215"><span style="position:relative; margin-left:5px; font-weight:bold;">সর্বমোট প্রদেয় বেতন ( ক - খ + গ + ঘ )  </span>
							<td >:</td>



							<td width="78" style="padding-right: 9px;" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $rows["gross_sal"] + $rows["ot_amount"] + $rows["eot_amount"] + $rows["att_bonus"] - $rows["total_deduct"];?> </font></td>
	...
	<div style="width:100%; height:auto; ">
		...
		{
			//echo "<div>";
			echo "<div style='width:320px;height:26px;text-align: right;font-weight:bold;'>Page No # $k of $page</div>";
			//echo "</div>";float:left
		} ?>
		<div style="width:320px; height:auto; overflow:hidden; font-size:9px; font-family: SolaimanLipi;margin-bottom:30px; border:1px solid black;">
			<div style="width:300px; height:40px; margin:0 auto; text-align:center;">
