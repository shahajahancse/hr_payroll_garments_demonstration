...
-->	  <?php } ?>
	...
	<td colspan="2" height="20px"><div align="center"><strong>কর্তন</strong></div></td>
...
<?php
   ...
   $in_total_sum			= 0;
	...
	/*	echo "<td>";
		...
		print_r ($value[$k]->m_l);
		echo "</td>";*/
		$abs_deduction 				= $value[$k]->abs_deduct_cnonc_mix;
		$total_abs_deduction 		= $total_abs_deduction + $abs_deduct_cnonc_mix;
		$grand_total_abs_deduction 	= $grand_total_abs_deduction + $abs_deduct_cnonc_mix;
		echo "<td>";
		echo $abs_deduction;
		echo "</td>";
		...
		$total_deduction		= $value[$k]->total_deduction_cnonc_mix;
...
//		echo "<td>";
//		echo $late_deduction."<br>($late_count)";\ //		echo "</td>";
//
