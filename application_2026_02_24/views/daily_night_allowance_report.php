...
<table class="bordered" border="1"  style="font-size:12px; text-align:center;">
	...
	<?php
		...
		for($i=0; $i<=$per_page_row; $i++){
			...
			echo "<td align='left'>";
			echo "<span style='font-family:Arial, Helvetica,white-space:nowrap; sans-serif;font-weight:bold;'>";
			...
			echo "<td align='right' style='padding-right:5px;white-space:nowrap;'>";
