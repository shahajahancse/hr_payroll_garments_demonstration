...
-->	  <?php } ?>
	...
	<td rowspan="2"  width="130" height="25"><div align="center"><strong>গ্রহীতার স্বাক্ষর</strong></div></td>
  </tr>
  <tr height="10px">
...
<?php
   ...
   $in_total_sum			= 0;
	...
	for($p=0; $p<=$per_page_row;$p++)
	{
		...
		echo $sec_bangla = $this->db->select('sec_bangla')->where('sec_id',$sec_id)->get('pr_section')->row()->sec_bangla;
		echo "</td>";
...
//		echo "</td>";
	...
	?>
	<tr>
		<td align="center" colspan="10" style="font-size:13px;"><strong>প্রতি পৃষ্ঠার মোট </strong></td>
		<!--<?php if($deduct_status == "Yes"){?>
		<td colspan="4"></td>
		 <?php }else{ ?>
		 <td colspan="3"></td>
